...
#import "Color.h"
#define CATDayLabelWidth ([UIScreen mainScreen].bounds.size.width-40)/7
...
- (void)setup
{
    ...
    //月份
    UILabel *masterLabel = [[UILabel alloc] initWithFrame:CGRectMake(10.f, 10.0f, [UIScreen mainScreen].bounds.size.width - 20, 30.f)];
    ...
    self.masterLabel.textColor = [UIColor cyanColor];
    ...
    self.day1OfTheWeekLabel.textColor = [UIColor redColor];
    ...
    self.day2OfTheWeekLabel.textColor = [UIColor cyanColor];
    ...
    self.day3OfTheWeekLabel.textColor = [UIColor cyanColor];
    ...
    self.day4OfTheWeekLabel.textColor = [UIColor cyanColor];
    ...
    self.day5OfTheWeekLabel.textColor = [UIColor cyanColor];
    ...
    self.day6OfTheWeekLabel.textColor = [UIColor cyanColor];
    ...
    self.day7OfTheWeekLabel.textColor = [UIColor cyanColor];
